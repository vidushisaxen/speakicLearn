      ...
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
                    ...
                    >
                      ...
                      {ageTooltipShown && (
                        <div className="absolute -right-5 top-full z-10 w-72 rounded-2xl border-2 border-gray-200 bg-white p-4 text-center text-xs leading-5 text-gray-800">
                          Providing your age ensures you get the right Speakic
                          experience. For more details, please visit our{" "}
                          <Link
                            href="https://www.Speakic.com/privacy"
          ...
          <p className="text-center text-xs leading-5 text-gray-400">
            By signing in to Speakic, you agree to our{" "}
            <Link
              className="font-bold"
              href="https://www.Speakic.com/terms?wantsPlainInfo=1"
            >
              Terms
            </Link>{" "}
            and{" "}
            <Link
              className="font-bold"
              href="https://www.Speakic.com/privacy?wantsPlainInfo=1"
            >
              Privacy Policy
            </Link>
            .
